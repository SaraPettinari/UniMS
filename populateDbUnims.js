...
var stud1 = new studenti({
    ...
    matricola: 'S001',
    codFacoltà: informatica.codFacoltà,
...
var stud3 = new studenti({
    ...
    matricola: 'S003',
    codFacoltà: matematica.codFacoltà,
...
var stud6 = new studenti({
    ...
    matricola: 'S006',
    codFacoltà: informatica.codFacoltà,
    email: 'alessando.leone@hotmail.it',
    emailUniversitaria: 'alessando.leone@studenti.unims.it',
    username: 'alessando.leone',
    password: createHash('alessando'),
    //carriera: [AppelliVerbalizzati], //'array of subdocument' contenente la carriera degli studenti
    annoCorso: 3
});
